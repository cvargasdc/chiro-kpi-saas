...
| `PHI_ENCRYPTION_KEY` | AES-256-GCM for patient email / phone / DOB / notes, onboarding checklist notes, care-plan names/notes, and project task notes (**must differ from MFA key**) |
